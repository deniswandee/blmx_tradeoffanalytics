...
public class TradeOffService {
	...
	TradeoffAnalytics service;
	
	public TradeOffService() {
		EnvVariables envVar = new EnvVariables();
		Map<String, String> creds = envVar.getCredentials("tradeoff_analytics");

		service = new TradeoffAnalytics(creds.get("username"), creds.get("password"));
	}
	
	public String analyzeTradeOff(String pref) {
